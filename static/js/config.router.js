          ...
          $stateProvider
              ...
              .state('app.mail', {
                  ...
                  resolve: {
                      ...
                      deps: ['$ocLazyLoad', 'uiLoad',
                          function( $ocLazyLoad, uiLoad ){
                              return $ocLazyLoad.load( ['js/app/mail/mail.js',
              ...
              .state('layout.app', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad', 'uiLoad',
                          function( $ocLazyLoad, uiLoad ){
                              return $ocLazyLoad.load( ['js/controllers/tab.js'] );
                      }]
                  }
              })
              .state('apps', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                          function( $ocLazyLoad ){
                              return $ocLazyLoad.load('ngGrid').then(
                                  function(){
                                      return $ocLazyLoad.load('js/controllers/userInfo.js');
                                  }
                              );
                          }]
                  }
