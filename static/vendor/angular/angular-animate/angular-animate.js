...
angular.module('ngAnimate', ['ng'])
 ...
 function($delegate,   $$q,   $injector,   $sniffer,   $rootElement,   $$asyncCallback,   $rootScope,   $document,   $templateRequest) {
      ...
      // Wait until all directive and route-related static are downloaded and
      // compiled. The $templateRequest.totalPendingRequests variable keeps track of
      // all of the remote static being currently downloaded. If there are no
      // static currently downloading then the watcher will still fire anyway.
      var deregisterWatch = $rootScope.$watch(
        ...
        function(val, oldVal) {
          ...
          // Now that all static have been downloaded, $animate will wait until
